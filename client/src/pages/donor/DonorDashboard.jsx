...
import DonorOpportunityFeed from "../../components/DonorOpportunityFeed";
...
const DonorDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-white p-6">
      ...
      {/* Donor Opportunity Feed - External Blood Needs */}
      {donor && (
        <div className="mb-8">
          <DonorOpportunityFeed 
            donorPincode={donor.address?.pincode} 
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <ActionCard
            ...
            onClick={() => {
              if (history.length === 0) {
                toast.error("No donations to certify. Make your first donation!");
          ...
          <ActionCard
            ...
            onClick={() => {
              const message = `I've donated blood ${dashboard?.stats?.totalDonations || 0} times and helped save ${dashboard?.stats?.livesImpacted || 0} lives! 🩸❤️ #BloodDonation #SaveLives`;
              if (navigator.share) {
