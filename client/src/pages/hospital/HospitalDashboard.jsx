          ...
          <div className="bg-white rounded-2xl shadow-lg border border-green-100 p-6">
            <div className="mb-4">
              ...
              <p className="text-sm text-gray-600 mt-1">
                Available near {hospital?.address?.pincode || 'your location'}
              </p>
            </div>
            ...
            {hospital?.address?.pincode ? (
              ...
              <div className="text-center py-8">
                ...
                <p className="text-sm text-gray-500">Update your hospital profile to see nearby blood banks</p>
              </div>
            )}
          </div>
        </div>
