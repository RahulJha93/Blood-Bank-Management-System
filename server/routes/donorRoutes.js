...
import { getDonorCamps, getDonorHistory, getDonorProfile, getDonorStats, updateDonorProfile, registerForCamp } from "../controllers/donorController.js";
...
router.post("/camps/:campId/register", protectDonor, registerForCamp);
